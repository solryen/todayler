    ...
    <section className="section hero-section">
      <PageShell className="hero-layout">
        <div className="hero-copy reveal reveal-visible reveal-fade-up">
          <BrandLockup />
          {HERO_CONTENT.eyebrow ? <p className="eyebrow">{HERO_CONTENT.eyebrow}</p> : null}
          <h1 className="hero-title">
            <span className="hero-title-wipe">{HERO_CONTENT.title}</span>
          </h1>
          <p className="hero-description section-lead">{HERO_CONTENT.description}</p>
          ...
          {HERO_CONTENT.finePrint ? <p className="fine-print">{HERO_CONTENT.finePrint}</p> : null}
        </div>
    ...
    <section className="section section-warm">
      <PageShell className="split-layout split-layout--reverse">
        <div className="section-copy">
          ...
          <p className="section-lead">{MIA_CONTENT.body}</p>
        </div>
        ...
        <div className="story-shell">
          <div className="story-copy">
            <div className="moon-mark" aria-hidden="true">
              <OutlineIcon type={STORY_CONTENT.icon} />
            </div>
            <Reveal as="h2" className="reveal reveal-fade-up">
              {STORY_CONTENT.title}
            </Reveal>
            <p className="section-lead">{STORY_CONTENT.body}</p>
          </div>
  ...
  return (
    <section className="section">
      <PageShell className="pricing-shell" narrow>
        ...
        <Reveal as="h2" className="reveal reveal-fade-up pricing-title">
  ...
  return (
    <section className="section final-cta">
      <PageShell narrow>
        ...
        {FINAL_CTA.finePrint ? <p className="fine-print">{FINAL_CTA.finePrint}</p> : null}
      </PageShell>
    </section>
  )
}
...
function BrandLockup() {
  return (
    <div className="brand-lockup">
      <img className="brand-mark brand-mark-pulse" src={logoImage} alt="Todayler" />
      <span>Todayler</span>
    </div>
  )
}
  ...
  const icons = {
    mind: (
      <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M11 13.2a4.6 4.6 0 0 1 4.7-4.2 4.8 4.8 0 0 1 4.8 3.6 4.1 4.1 0 0 1 3.5 4.1 4.3 4.3 0 0 1-4.4 4.3H13a5 5 0 0 1-5-5 4.5 4.5 0 0 1 3-4.2Z" />
        <path d="M14 14.5c1.1 0 1.8.8 1.8 1.8S15.1 18 14 18s-1.8-.8-1.8-1.7.7-1.8 1.8-1.8Zm5-.2c.9 0 1.7.7 1.7 1.7 0 1-.8 1.7-1.7 1.7-1 0-1.8-.7-1.8-1.7 0-1 .8-1.7 1.8-1.7Z" />
        <path d="M16 21.5v3.8m-3.2 0h6.4" />
      </svg>
    ),
    crawl: (
      <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <circle cx="12.2" cy="7.8" r="2.3" />
        <path d="M12.2 10.3v5.3" />
        <path d="M12.2 12.4 8.6 15.4" />
        <path d="M12.2 12.2 16.6 14.2" />
        <path d="M12.2 15.6 8.8 21.4" />
        <path d="M12.2 15.6 16.8 20.4" />
        <path d="M18.8 11.6c2 1 3.6 2.3 4.8 4" />
        <path d="M21 8.9c2.3 1.1 4.1 2.8 5.4 5" />
      </svg>
    ),
    bond: (
      <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <circle cx="19.6" cy="8.8" r="2.9" />
        <circle cx="11.1" cy="14.2" r="2.1" />
        <path d="M16.8 23.8v-6.2a3.6 3.6 0 0 1 3.6-3.6h1.4a3.4 3.4 0 0 1 3.4 3.4v6.4" />
        <path d="M9 23.8v-3.1a2.9 2.9 0 0 1 2.9-2.9h.7a2.9 2.9 0 0 1 2.9 2.9v3.1" />
        <path d="M16.4 17.8c-1.4.2-2.8-.2-4-1.1" />
        <path d="M16.9 20.8c-1.7.4-3.5.2-5-.7" />
      </svg>
    ),
    moon: (
      <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M21.8 5.9a10.7 10.7 0 1 0 4.3 20.6A11.6 11.6 0 0 1 21.8 5.9Z" />
      </svg>
    ),
  }
